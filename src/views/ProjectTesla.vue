    ...
    <div class="project">
        ...
        <div class="container">
            ...
            <div 
                class="container__img"
            >
                <img :src="projectInfos.imgs[3][0]">
            </div>
            <div 
                class="container__img"
            >
                <img :src="projectInfos.imgs[4][0]">
            </div>
            <div 
                class="container__img"
            >
            ...
            <div 
                class="container__img"
            >
                <img :src="projectInfos.imgs[8][0]">
            </div>
            <div 
                class="container__img"
            >
                <img :src="projectInfos.imgs[9][0]">
            </div>
            <div 
                class="container__img"
            >
            ...
            <div 
                class="container__img"
            >
                <img :src="projectInfos.imgs[13][0]">
            </div>
            <div 
                class="container__img"
            >
